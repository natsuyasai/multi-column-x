...
1. [ステージ名] - _理由：_ [実行する理由]
2. [ステージ名] - _理由：_ [実行する理由]
   ...

🟢 **CONSTRUCTION PHASE：** 3. [ステージ名] - _理由：_ [実行する理由] 4. [ステージ名] - _理由：_ [実行する理由]
...
...
1. [ステージ名] - _理由：_ [スキップする理由]
2. [ステージ名] - _理由：_ [スキップする理由]
   ...

🟢 **CONSTRUCTION PHASE：** 3. [ステージ名] - _理由：_ [スキップする理由] 4. [ステージ名] - _理由：_ [スキップする理由]
...
