...
観点としてRobert C.MartinのClean Codeの原則も考慮します。
...
- Robert C.MartinのClean Codeの原則に基づくその他のコードの臭い
...
- Robert C.MartinのClean Codeの原則に基づくその他のリファクタリング手法
