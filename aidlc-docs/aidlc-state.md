...
| 項目                                            | ブランチ / PR                                             | 状態                                                                                                                                                    |
| ----------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| デスクトップのプリセット読込で WebView 未再生成 | `fix/desktop-preset-reload`（`feat/mobile-presets` 起点） | 🔄 バグ確定・修正済み（6bace06）。追加で「プリセットID不一致時の旧 WebView リーク」疑いを同ブランチで調査・修正中。完了後に PR 作成（#38 へのスタック） |
